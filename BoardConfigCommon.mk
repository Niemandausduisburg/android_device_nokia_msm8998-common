...
TARGET_PREBUILT_KERNEL := $(COMMON_PATH)/prebuilts/kernel/Image.gz-dtb
TARGET_DEVICE_KERNEL_HEADERS := $(strip $(wildcard $(TARGET_DEVICE_DIR)/prebuilts/kernel-headers))
